# Linux Command Cheat Sheet – DevOps Toolkit

## 1 Process Management Commands:
- **ps aux** - Shows all running process with CPU and Memory usage.
...
- **kill** - Shutdown process gracefully.

## 2 File System Command:
- **pwd** - Current working directory
- **ls** - List file and directory.
- **ls -l** - List file and directory in detailed format(Permissions,ownership,size,timestamp)
- **ls -a** - List file and directory includes hidden files.
- **mkdir** - Create Directory.
- **rm <file_name>** - Remove file.
- **rm -r <directory-name>** - Remove directory (-r = recurrsively).
- **cp <src> <dest>** - Copy file.
- **mv <src> <dest>** - Move/Rename file.
- **cat <file_name>** - For viewing file.
- **head <file_name>** - Display top 10 lines.
